...
function powerSwitch() {
    let noteContainer = document.getElementsByClassName('note-container')[0]; // change to tempo container
    ...
    if (instrumentPower === true) {
        ...
        noteContainer.style.pointerEvents = 'none';  // change to tempo container
        ...
        noteContainer.style.pointerEvents = 'auto'; // change to tempo container
        btnsToDisplay.forEach((item) => {
...
function performCheck() {
    ...
    if (freeModeBool === true || instrumentPower === false) {
        ...
        patCheck(); // change to tempo checker
    }
